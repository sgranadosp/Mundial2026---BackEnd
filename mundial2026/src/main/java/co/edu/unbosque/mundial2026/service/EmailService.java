 ...
 * Provee plantillas HTML responsivas para dos flujos:
 * <ul>
 ...
 * destacado en un recuadro con borde punteado, y footer institucional.
 * Si SMTP falla, los errores se loggean pero no se propagan al caller
 * para que el flujo de registro / recuperación no se interrumpa.
 * </p>
 */
@Service
public class EmailService {
    ...
    private String construirHtmlVerificacion(String nombre, String codigo) {
        ...
        String introduccion =
                "Gracias por crear una cuenta. Estamos a un paso de tenerte adentro: solo nos falta "
        ...
        String instrucciones =
                "Ingresa este código en la pantalla de verificación que se abrió después del registro. "
                + "Una vez verificado, podrás iniciar sesión y disfrutar de toda la experiencia del "
                + "Mundial 2026.";

        String avisos =
                "El código es de un solo uso. Si no fuiste tú quien creó esta cuenta, simplemente ignora "
    ...
    private String construirHtmlRecuperacion(String nombre, String codigo) {
        ...
        String introduccion =
                "Recibimos una solicitud para restablecer la contraseña de tu cuenta de Mundial 2026 Hub. "
                + "Si tú la pediste, usa el siguiente código para continuar con el proceso:";

        String instrucciones =
                "Vuelve a la pantalla de recuperación en la aplicación, ingresa el código de arriba y "
                + "define tu nueva contraseña. El código queda invalidado tras completar el cambio.";

        String avisos =
                "Si no solicitaste este cambio, puedes ignorar este correo: tu contraseña actual seguirá "
     ...
     * <p>
     * La plantilla está diseñada para verse bien en clientes de correo como
     * Gmail, Outlook, Apple Mail y Yahoo. Usa estilos inline (los clientes
     * web suelen filtrar {@code <style>} en {@code <head>}) y layout basado
     * en tablas con anchos absolutos para máxima compatibilidad. Es
     * responsiva hasta cierto punto: en móviles se ajusta al ancho de la
     * pantalla manteniendo el padding interno.
     * </p>
     *
     * @param tituloHeader  Título mostrado en el header dorado.
     * @param emoji         Emoji que acompaña al título (ej. ⚽, 🔐).
     * @param saludo        Saludo personalizado al usuario (HTML permitido para &lt;strong&gt;).
     * @param introduccion  Párrafo de introducción que explica por qué llega el correo.
     * @param codigo        Código de 6 dígitos a mostrar destacado.
     * @param instrucciones Párrafo con los pasos a seguir.
     * @param avisos        Párrafo de avisos de seguridad e ignorar si no fue solicitado.
     * @return Cadena HTML completa lista para enviar como cuerpo del correo.
     */
    private String construirPlantillaBase(String tituloHeader, String emoji, String saludo,
                                           String introduccion, String codigo,
                                           String instrucciones, String avisos) {
        return ""
            + "<!DOCTYPE html>"
            + "<html lang=\"es\">"
            + "<head>"
            ...
            + "<tr>"
            + "<td style=\"background:linear-gradient(135deg," + COLOR_DORADO + " 0%,"
            + COLOR_DORADO_CLARO + " 100%);"
            + " padding:28px 30px; text-align:center;\">"
            + "<h1 style=\"margin:0; font-size:26px; font-weight:700; color:#1a1a1a;"
            + " letter-spacing:0.5px;\">"
            + emoji + " &nbsp; Mundial 2026 Hub &nbsp; " + emoji
            + "</h1>"
            ...
            + "<table role=\"presentation\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\""
            + " width=\"100%\" style=\"margin:0 auto 28px auto;\">"
            + "<tr>"
            + "<td align=\"center\""
            + " style=\"background-color:" + COLOR_FONDO_CODIGO + ";"
            + " border:2px dashed " + COLOR_DORADO + ";"
            + " border-radius:10px; padding:24px 20px;\">"
            + "<p style=\"margin:0 0 8px 0; font-size:11px; color:" + COLOR_TEXTO_SECUNDARIO + ";"
            ...
            + " color:" + COLOR_DORADO + "; font-style:italic; text-align:center;\">"
            ...
            + " color:" + COLOR_TEXTO + ";\">"
            + "Un saludo,<br>"
            + "<strong style=\"color:" + COLOR_DORADO + ";\">El equipo de Mundial 2026 Hub</strong>"
            + "</p>"
